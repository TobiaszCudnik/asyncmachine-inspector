    ...
    <div>
      ...
      <div className="modal-wrapper">
        <div className="modal-content legend">
          <h4>Rules</h4>
          <ol>
            <li>State can be active or inactive and are grouped in machines</li>
            <li>
              State changes are always synchronous and performed by transitions
            </li>
            <li>
            ...
            <li>
              States take part in a transition by either: a request, a relation
              or a pipe
            </li>
            <li>
            ...
            <li>Auto-states try to set themselves after every state change</li>
            <li>
        ...
        <div>
          ...
          <ul className="relations">
            <li>
              ...
              <span>
                When the source state gets activated, the target state also gets
                activated
              </span>
            </li>
            <li>
              ...
              <span>
                To get the source state activated, the target states needs to be
                active (or about to be activated)
              </span>
            </li>
            <li>
              <span style={{ float: 'left' }}>
