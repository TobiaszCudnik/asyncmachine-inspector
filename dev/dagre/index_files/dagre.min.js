    ...
    return function e(t, n, r) {
        ...
        17: [function(require, module, exports) {
            ...
            function order(g) {
                ...
                for (var i = 0, lastBest = 0; lastBest < 4; ++i,
                ++lastBest) {
        ...
        22: [function(require, module, exports) {
            ...
            function findPath(g, postorderNums, v, w) {
                ...
                do {
                    ...
                    vPath.push(parent)
                } while (parent && (postorderNums[parent].low > low || lim > postorderNums[parent].lim));lca = parent;
                parent = w;
        ...
        29: [function(require, module, exports) {
            ...
            function addDummyNode(g, type, attrs, name) {
                ...
                do {
                    v = _.uniqueId(name)
                } while (g.hasNode(v));attrs.dummy = type;
                g.setNode(v, attrs);
                return v
            }
            function simplify(g) {
                    ...
                    function runInContext(context) {
                        ...
                        function baseReduce(collection, iteratee, accumulator, initFromCollection, eachFunc) {
                            eachFunc(collection, function(value, index, collection) {
                                accumulator = initFromCollection ? (initFromCollection = false,
                        ...
                        var zipWith = restParam(function(arrays) {
                            ...
                            if (length > 2 && typeof iteratee == "function") {
                                ...
                                iteratee = length > 1 && typeof thisArg == "function" ? (--length,
                                thisArg) : undefined;
                                thisArg = undefined
                            }
