(function(root, factory) {
    ...
    var g = function() {
        ...
        a.bezier = {
            ...
            getCurveControlPoints: function(a) {
                var b, c = [], d = [], e = a.length - 1;
                if (1 == e)
                    return c[0] = p((2 * a[0].x + a[1].x) / 3, (2 * a[0].y + a[1].y) / 3),
                    d[0] = p(2 * c[0].x - a[0].x, 2 * c[0].y - a[0].y),
                    [c, d];
                var f = [];
                for (b = 1; b < e - 1; b++)
                    f[b] = 4 * a[b].x + 2 * a[b + 1].x;
                f[0] = a[0].x + 2 * a[1].x,
                f[e - 1] = (8 * a[e - 1].x + a[e].x) / 2;
                var g = this.getFirstControlPoints(f);
                for (b = 1; b < e - 1; ++b)
                    f[b] = 4 * a[b].y + 2 * a[b + 1].y;
                f[0] = a[0].y + 2 * a[1].y,
                f[e - 1] = (8 * a[e - 1].y + a[e].y) / 2;
                var h = this.getFirstControlPoints(f);
                for (b = 0; b < e; b++)
                    c.push(p(g[b], h[b])),
                    b < e - 1 ? d.push(p(2 * a[b + 1].x - g[b + 1], 2 * a[b + 1].y - h[b + 1])) : d.push(p((a[e].x + g[e - 1]) / 2, (a[e].y + h[e - 1]) / 2));
                return [c, d]
            },
        ...
        var n = a.Ellipse = function(a, b, c) {
            return this instanceof n ? a instanceof n ? new n(p(a),a.a,a.b) : (a = p(a),
            this.x = a.x,
            this.y = a.y,
            this.a = b,
            void (this.b = c)) : new n(a,b,c)
        }
        ;
        a.Ellipse.fromRect = function(a) {
            return a = q(a),
            n(a.center(), a.width / 2, a.height / 2)
        }
        ,
        a.Ellipse.prototype = {
            bbox: function() {
            ...
            tangentTheta: function(b) {
                var c, d, e = 30, f = b.x, g = b.y, h = this.a, i = this.b, j = this.bbox().center(), k = j.x, l = j.y, m = f > j.x + h / 2, n = f < j.x - h / 2;
                return m || n ? (c = f > j.x ? g - e : g + e,
                d = h * h / (f - k) - h * h * (g - l) * (c - l) / (i * i * (f - k)) + k) : (d = g > j.y ? f + e : f - e,
                c = i * i / (g - l) - i * i * (f - k) * (d - k) / (h * h * (g - l)) + l),
                a.point(d, c).theta(b)
            },
            equals: function(a) {
                return a = n(a),
                a.x === this.x && a.y === this.y && a.a === this.a && a.b === this.b
            },
            intersectionWithLineFromCenterToPoint: function(a, b) {
                a = p(a),
                b && a.rotate(p(this.x, this.y), b);
                var c, d = a.x - this.x, e = a.y - this.y;
                if (0 === d)
                    return c = this.bbox().pointNearestToPoint(a),
                    b ? c.rotate(p(this.x, this.y), -b) : c;
                var g = e / d
                  , h = g * g
                  , i = this.a * this.a
                  , j = this.b * this.b
        ...
        var o = a.Line = function(a, b) {
            return this instanceof o ? (this.start = p(a),
            void (this.end = p(b))) : new o(a,b)
        }
        ;
        a.Line.prototype = {
            bearing: function() {
        ...
        a.Point.prototype = {
            adhereToRect: function(a) {
                return a.containsPoint(this) ? this : (this.x = g(h(this.x, a.x), a.x + a.width),
                this.y = g(h(this.y, a.y), a.y + a.height),
                this)
            },
            bearing: function(a) {
            ...
            round: function(a) {
                return this.x = a ? this.x.toFixed(a) : j(this.x),
                this.y = a ? this.y.toFixed(a) : j(this.y),
                this
            },
            scale: function(a, b, c) {
                return c = c && p(c) || p(0, 0),
                this.x = c.x + a * (this.x - c.x),
                this.y = c.y + b * (this.y - c.y),
                this
            },
            snapToGrid: function(a, b) {
                return this.x = s(this.x, a),
                this.y = s(this.y, b || a),
                this
            },
            theta: function(a) {
            ...
            toPolar: function(a) {
                ...
                var b = this.x
                  , c = this.y;
                return this.x = f((b - a.x) * (b - a.x) + (c - a.y) * (c - a.y)),
                this.y = u(a.theta(p(b, c))),
                this
            },
            toString: function() {
        ...
        var q = a.Rect = function(a, b, c, d) {
            return this instanceof q ? (Object(a) === a && (b = a.y,
            c = a.width,
            d = a.height,
            a = a.x),
            this.x = void 0 === a ? 0 : a,
            this.y = void 0 === b ? 0 : b,
            this.width = void 0 === c ? 0 : c,
            void (this.height = void 0 === d ? 0 : d)) : new q(a,b,c,d)
        }
        ;
        a.Rect.fromEllipse = function(a) {
            return a = n(a),
            q(a.x - a.a, a.y - a.b, 2 * a.a, 2 * a.b)
        }
        ,
        a.Rect.prototype = {
            bbox: function(a) {
            ...
            containsPoint: function(a) {
                return a = p(a),
                a.x >= this.x && a.x <= this.x + this.width && a.y >= this.y && a.y <= this.y + this.height
            },
            ...
            intersect: function(a) {
                var b = this.origin()
                  ...
                  , d = a.origin()
                  , e = a.corner();
                if (e.x <= b.x || e.y <= b.y || d.x >= c.x || d.y >= c.y)
                    return null ;
            ...
            round: function(a) {
                return this.x = a ? this.x.toFixed(a) : j(this.x),
                this.y = a ? this.y.toFixed(a) : j(this.y),
                this.width = a ? this.width.toFixed(a) : j(this.width),
                this.height = a ? this.height.toFixed(a) : j(this.height),
                this
            },
            scale: function(a, b, c) {
                return c = this.origin().scale(a, b, c),
                this.x = c.x,
                this.y = c.y,
                this.width *= a,
                this.height *= b,
    ...
    V = Vectorizer = function() {
        ...
        d.prototype.append = function(a) {
            ...
            for (var b = 0, c = a.length; b < c; b++)
                this.node.appendChild(d.toNode(a[b]));
            return this
        }
        ,
    ...
    var joint = {
        ...
        setTheme: function(a, b) {
            b = b || {},
            _.invoke(joint.mvc.views, "setTheme", a, b),
            joint.mvc.View.prototype.defaultTheme = a
        },
        env: {
            _results: {},
            _tests: {
        ...
        util: {
            ...
            imageToDataUri: function(a, b) {
                ...
                var c = function(b, c) {
                  ...
                  , d = function(b, c) {
                    var d = function(a) {
                        for (var b = 32768, c = [], d = 0; d < a.length; d += b)
                            c.push(String.fromCharCode.apply(null , a.subarray(d, d + b)));
                        return c.join("")
                    }
                    ;
                    if (200 === b.status) {
                ...
                e.responseType = window.FileReader ? "blob" : "arraybuffer",
                ...
                return function(c) {
                    ...
                    a.replace(b, function(a) {
                        for (var b = Array.prototype.slice.call(arguments), d = _.find(b.slice(1, 4), function(a) {
                            return !!a
                        }), e = d.split("."), f = c[e.shift()]; !_.isUndefined(f) && e.length; )
                            f = f[e.shift()];
            ...
            toggleFullScreen: function(a) {
                function b(a, b) {
                    for (var c = ["webkit", "moz", "ms", "o", ""], d = 0; d < c.length; d++) {
                        ...
                        if (!_.isUndefined(a[f]))
                            return _.isFunction(a[f]) ? a[f]() : a[f]
                    }
                }
                a = a || document.body,
                b(document, "FullScreen") || b(document, "IsFullScreen") ? b(document, "CancelFullScreen") : b(a, "RequestFullScreen")
            },
            addClassNamePrefix: function(a) {
                return a ? _.map(a.toString().split(" "), function(a) {
                    return a.substr(0, joint.config.classNamePrefix.length) !== joint.config.classNamePrefix && (a = joint.config.classNamePrefix + a),
                    a
                }).join(" ") : a
            },
            removeClassNamePrefix: function(a) {
                return a ? _.map(a.toString().split(" "), function(a) {
                    return a.substr(0, joint.config.classNamePrefix.length) === joint.config.classNamePrefix && (a = a.substr(joint.config.classNamePrefix.length)),
                    a
                }).join(" ") : a
            },
            wrapWith: function(a, b, c) {
                if (_.isString(c)) {
                    if (!joint.util.wrappers[c])
                        throw new Error('Unknown wrapper: "' + c + '"');
            ...
            wrappers: {
                cells: function(a) {
                    return function() {
                        ...
                        return _.isArray(c) || (d instanceof joint.dia.Cell ? (c = b,
                        d = {}) : c = _.initial(b)),
                        a.call(this, c, d)
                    }
                }
    ...
    joint.mvc.View = Backbone.View.extend({
        ...
        initialize: function(a) {
            this.requireSetThemeOverride = a && !!a.theme,
        ...
        setTheme: function(a, b) {
            if (b = b || {},
            !this.theme || !this.requireSetThemeOverride || b.override)
                return this.removeThemeClassName(),
                this.addThemeClassName(a),
                this.onSetTheme(this.theme, a),
                this.theme = a,
                this
        },
        addThemeClassName: function(a) {
            ...
            return this.$el.addClass(b),
            this
        },
        removeThemeClassName: function(a) {
            a = a || this.theme;
            var b = this.themeClassNamePrefix + a;
            return this.$el.removeClass(b),
            this
        },
    ...
    function() {
        ...
        joint.mvc.View.extend = function(a, b) {
            a = a || {};
    ...
    joint.dia.Graph = Backbone.Model.extend({
        ...
        clear: function(a) {
            ...
            do
                c.shift().remove(a);
            while (c.length > 0);return this.stopBatch("clear"),
            this
        },
        ...
        addCell: function(a, b) {
            return _.isArray(a) ? this.addCells(a, b) : (a instanceof Backbone.Model ? a.has("z") || a.set("z", this.maxZIndex() + 1) : _.isUndefined(a.z) && (a.z = this.maxZIndex() + 1),
            this.get("cells").add(this._prepareCell(a), b || {}),
            this)
        },
        addCells: function(a, b) {
            return a.length && (a = _.flattenDeep(a),
            b.position = a.length,
            this.startBatch("add"),
            _.each(a, function(a) {
                b.position--,
        ...
        removeCells: function(a, b) {
            return a.length && (this.startBatch("remove"),
            _.invoke(a, "remove", b),
        ...
        cloneCells: function(a) {
            ...
            return _.each(a, function(a) {
                ...
                if (c.isLink()) {
                    var d = c.get("source")
                      , e = c.get("target");
                    d.id && b[d.id] && c.prop("source/id", b[d.id].id),
                    e.id && b[e.id] && c.prop("target/id", b[e.id].id)
                }
                var f = a.get("parent");
                f && b[f] && c.set("parent", b[f].id);
                var g = _.reduce(a.get("embeds"), function(a, c) {
                    return b[c] && a.push(b[c].id),
                    a
                }, []);
        ...
        isNeighbor: function(a, b, c) {
            ...
            return _.each(this.getConnectedLinks(a, c), function(a) {
                var c = a.get("source")
                  , g = a.get("target");
                return d && _.has(c, "id") && c.id === b.id ? (f = !0,
                !1) : e && _.has(g, "id") && g.id === b.id ? (f = !0,
                !1) : void 0
            }),
            f
        },
        ...
        startBatch: function(a, b) {
            return b = b || {},
            this._batches[a] = (this._batches[a] || 0) + 1,
            this.trigger("batch:start", _.extend({}, b, {
                batchName: a
            }))
        },
        stopBatch: function(a, b) {
            return b = b || {},
            this._batches[a] = (this._batches[a] || 0) - 1,
            this.trigger("batch:stop", _.extend({}, b, {
                batchName: a
            }))
        },
    ...
    joint.dia.Cell = Backbone.Model.extend({
        ...
        toFront: function(a) {
            if (this.graph) {
                ...
                if (this.startBatch("to-front").set("z", b, a),
                a.deep) {
        ...
        unembed: function(a, b) {
            return this.startBatch("unembed"),
            a.unset("parent", b),
    ...
    joint.dia.CellView = joint.mvc.View.extend({
        ...
        getSelector: function(a, b) {
            ...
            if (a) {
                var d = V(a).index() + 1;
                c = a.tagName + ":nth-child(" + d + ")",
                b && (c += " > " + b),
                c = this.getSelector(a.parentNode, c)
            }
            return c
        },
        ...
        pointerdown: function(a, b, c) {
            this.model.graph && (this.model.startBatch("pointer"),
        ...
        pointerup: function(a, b, c) {
            ...
            this._graph && (this._graph.stopBatch("pointer", {
                cell: this.model
            }),
            delete this._graph)
        },
    ...
    joint.dia.Element = joint.dia.Cell.extend({
        ...
        resize: function(a, b, c) {
            ...
            return this.stopBatch("resize", c),
            this
        },
        scale: function(a, b, c, d) {
            var e = this.getBBox().scale(a, b, c);
            return this.startBatch("scale", d),
            this.position(e.x, e.y, d),
            this.resize(e.width, e.height, d),
        ...
        rotate: function(a, b, c, d) {
            if (c) {
                ...
                this.translate(h, i, _.clone(d)),
                this.rotate(a, b, null , d),
                this.stopBatch("rotate")
            } else
                this.set("angle", b ? a : (this.get("angle") + a) % 360, d);
            return this
        },
        getBBox: function(a) {
            if (a = a || {},
    ...
    joint.dia.ElementView = joint.dia.CellView.extend({
        ...
        initialize: function() {
            ...
            var a = this.model;
            this.listenTo(a, "change:position", this.translate),
            this.listenTo(a, "change:size", this.resize),
            this.listenTo(a, "change:angle", this.rotate),
        ...
        updateAttr: function(a, b) {
            ...
            _.isObject(b.filter) && (c.push("filter"),
            this.applyFilter(a, b.filter)),
            _.isObject(b.fill) && (c.push("fill"),
            this.applyGradient(a, "fill", b.fill)),
            _.isObject(b.stroke) && (c.push("stroke"),
            this.applyGradient(a, "stroke", b.stroke)),
            _.isUndefined(b.text) || (a.each(function() {
                _.isUndefined(b.x) || (V(this).attr("x", b.x),
                c.push("x")),
                _.isUndefined(b.y) || (V(this).attr("y", b.y),
                c.push("y")),
                V(this).text(b.text + "", {
            ...
            b.port && a.attr("port", _.isUndefined(b.port.id) ? b.port : b.port.id),
            b.style && a.css(b.style),
            _.isUndefined(b.html) || a.each(function() {
                $(this).html(b.html + "")
            })
        },
        update: function(a, b) {
        ...
        positionRelative: function(a, b, c, d) {
            ...
            isFinite(j) && (k || j > 0 && j < 1 ? v = b.y + b.height * j : r ? (t = t || r.scale(),
            v = b.y + j / t.sy) : v = b.y + j),
            !_.isUndefined(h) || !_.isUndefined(i)) {
                var w = a.node
                  , x = a.bbox(!1, w.parentNode)
                  , y = w.nodeName.toUpperCase();
                "TEXT" !== y && "TSPAN" !== y || (x.height += x.y,
                x.width += x.x),
                r && (t = t || r.scale(),
                x.width *= t.sx,
                x.height *= t.sy),
                "middle" === h ? v -= x.height / 2 : "bottom" === h ? v -= x.height : isFinite(h) && (v += h > -1 && h < 1 ? x.height * h : h),
                "middle" === i ? u -= x.width / 2 : "right" === i ? u -= x.width : isFinite(i) && (u += i > -1 && i < 1 ? x.width * i : i)
            }
            a.translate(u, v)
        },
        ...
        pointerup: function(a, b, c) {
            ...
            this._linkView = null ,
            this.model.stopBatch("add-link")) : (this._inProcessOfEmbedding && (this.finalizeEmbedding(),
    ...
    joint.dia.Link = joint.dia.Cell.extend({
        ...
        applyToPoints: function(a, b) {
            ...
            return f && f.length > 0 && (c.vertices = _.map(f, a)),
            this.set(c, b)
        },
        reparent: function(a) {
            var b;
    ...
    joint.dia.LinkView = joint.dia.CellView.extend({
        ...
        render: function() {
            ...
            _.each(c, function(a) {
                var b = a.attr("class");
                b && (b = joint.util.removeClassNamePrefix(b),
                this._V[$.camelCase(b)] = a)
            }, this),
            !this._V.connection)
            ...
            if (!_.isNaN(c)) {
                ...
                _.each(a, function(a, e) {
                    ...
                    if (_.isObject(i))
                        ...
                        for (var k, l, m, n = 1 / 0, o = 0; o < d.length; o++)
                            l = d[o],
                            m = g.line(l, j).squaredLength(),
                            m < n && (n = m,
                            k = o);
                        var p = d[k - 1]
                          , q = d[k + 1]
                          , r = 0;
                        q ? r = g.point(j).theta(q) : p && (r = g.point(p).theta(j)),
                        j = g.point(j).offset(i).rotate(j, r - 90)
                    }
        ...
        getConnectionPoint: function(a, b, c) {
            ...
            b.id) {
                ...
                if (c.id) {
                    ...
                    e = h.intersectionWithLineFromCenterToPoint(f.center()),
                    e = e || h.center()
                } else
                    e = g.Point(c);
                var i = this.paper.options;
                if (i.perpendicularLinks || this.options.perpendicular) {
                    var j, k = f.origin(), l = f.corner();
                    if (k.y <= e.y && e.y <= l.y)
                        switch (j = f.sideNearestToPoint(e)) {
                        case "left":
                            d = g.Point(k.x, e.y);
                            break;
                        case "right":
                        ...
                        d = f.intersectionWithLineFromCenterToPoint(e),
                        d = d || f.center()
        ...
        _markAvailableMagnets: function() {
            ...
            this._marked = {},
            _.chain(c).map(b.findViewByModel, b).each(function(b) {
        ...
        startArrowheadMove: function(a, b) {
            ...
            this._arrowhead = a,
            this._initialMagnet = this[a + "Magnet"] || (this[a + "View"] ? this[a + "View"].el : null ),
        ...
        pointerdown: function(a, b, c) {
            ...
            null == a.target.getAttribute("magnet")) {
                var d, e = joint.util.removeClassNamePrefix(a.target.getAttribute("class")), f = joint.util.removeClassNamePrefix(a.target.parentNode.getAttribute("class"));
                switch ("label" === f ? (e = f,
                d = a.target.parentNode) : d = a.target,
                e) {
                case "marker-vertex":
                ...
                case "label":
                    ...
                    this._labelIdx = parseInt(V(d).attr("label-idx"), 10),
        ...
        pointermove: function(a, b, c) {
            ...
            case "label-move":
                for (var e, f, h, i, j = {
                    x: b,
                    y: c
                }, k = this._samples, l = 1 / 0, m = 0, n = k.length; m < n; m++)
                    h = k[m],
        ...
        pointerup: function(a, b, c) {
            if ("label-move" === this._action)
                ...
                var d, e = this.paper, f = e.options, g = this._arrowhead, h = this._initialEnd;
                if (f.snapLinks)
                    this._closestView && (this._closestView.unhighlight(this._closestEnd.selector, {
                        connecting: !0,
                        snapping: !0
                    }),
                    d = this._closestView.findMagnet(this._closestEnd.selector)),
                    this._closestView = this._closestEnd = null ;
                else {
                    var i = this._viewUnderPointer;
                    if (d = this._magnetUnderPointer,
                ...
                n && (h.id && this.notify("link:disconnect", a, e.findViewByModel(h.id), this._initialMagnet, g),
                m.id && this.notify("link:connect", a, e.findViewByModel(m.id), d, g)),
    ...
    joint.dia.Paper = joint.mvc.View.extend({
        ...
        resolveHighlighter: function(a) {
            ...
            if (!f)
                throw new Error('Unknown highlighter ("' + e + '")');
            if ("function" != typeof f.highlight)
                throw new Error('Highlighter ("' + e + '") is missing required highlight() method');
            if ("function" != typeof f.unhighlight)
        ...
        onCellHighlight: function(a, b, c) {
            if (c = this.resolveHighlighter(c)) {
                ...
                if (!this._highlights[d]) {
                    var e = c.highlighter;
                    e.highlight(a, b, _.clone(c.options)),
                    this._highlights[d] = {
                        cellView: a,
                        magnetEl: b,
                        opt: c.options,
        ...
        onCellUnhighlight: function(a, b, c) {
            if (c = this.resolveHighlighter(c)) {
                ...
                e && (e.highlighter.unhighlight(e.cellView, e.magnetEl, e.opt),
                this._highlights[d] = null )
            }
        },
        ...
        contextmenu: function(a) {
            a = joint.util.normalizeEvent(a),
            this.options.preventContextMenu && a.preventDefault();
            var b = this.findView(a.target);
            if (!this.guard(a, b)) {
                var c = this.snapToGrid({
                    x: a.clientX,
        ...
        setGridSize: function(a) {
            return this.options.gridSize = a,
            this.options.drawGrid && this.drawGrid(),
            this
        },
        clearGrid: function() {
            return this.el.style.backgroundImage = "none",
            this
        },
        drawGrid: function(a) {
            ...
            k.beginPath(),
            k.rect(h, i, a.thickness * d, a.thickness * e),
            k.fillStyle = a.color,
            k.fill();
            var l = j.toDataURL("image/png");
            return this.el.style.backgroundImage = 'url("' + l + '")',
            this
        },
        setInteractivity: function(a) {
            this.options.interactive = a,
            _.invoke(this._views, "setInteractivity", a)
        }
    }),
    function(a, b) {
        var c = function(a) {
            var c = b.cloneDeep(a);
            this.ports = [],
            this.groups = this._getNormalizedGroups(c),
            this._init(c)
        }
        ;
        c.prototype = {
            ...
            _evaluatePort: function(a) {
                ...
                return c.markup = c.markup || d.markup,
                c.attrs = b.merge({}, d.attrs, c.attrs),
                c.position = b.merge(this._createPositionNode(), d.position, {
                    args: c.args
                }),
                c.label = b.merge({}, d.label, this._getLabel(c)),
                c.z = this._getZIndex(c.z, d.z),
                c
            },
            ...
            _getNormalizedGroups: function(a) {
                return a = a || {},
                a.groups = a.groups || {},
                b.each(a.groups, function(a) {
                    a.position = this._getPosition(a.position, !0),
                    a.label = this._getLabel(a, !0)
                }, this),
                a.groups
            },
            _getPosition: function(a, c) {
                var d, e = {};
                b.isFunction(a) ? (d = "fn",
                e.fn = a) : b.isString(a) ? d = a : b.isUndefined(a) ? d = c ? "left" : null : b.isArray(a) ? (d = "absolute",
                e.x = a[0],
                e.y = a[1]) : b.isObject(a) && (d = a.name,
                b.extend(e, a.args));
                var f = {
                    args: e
                };
            ...
            _getLabel: function(a, b) {
                var c = a.label || {}
                  , d = c;
                return d.position = this._getPosition(c.position, b),
                d
            }
        },
        b.extend(a.dia.Element.prototype, {
            ...
            addPort: function(a, c) {
                if (!b.isObject(a) || b.isArray(a))
                    throw new Error("Element: addPort requires an object.");
                var d = b.clone(this.prop("ports/items")) || [];
                return d.push(a),
                this.prop("ports/items", d, c),
                this
            },
            portProp: function(a, c, d, e) {
                var f = this.getPortIndex(a);
                if (f === -1)
                    throw new Error("Element: unable to find port with id " + a);
                var g;
                return b.isString(c) ? (g = Array.prototype.slice.call(arguments, 1),
                g[0] = ["ports/items/", f, "/", c].join("")) : g = ["ports/items/" + f, c, d],
                this.prop.apply(this, g)
            },
            _validatePorts: function() {
                ...
                b.uniq(e, "id").length !== e.length && d.push("Element: found id duplicities in ports."),
                d
            },
            ...
            addPorts: function(a, c) {
                return a.length && this.prop("ports/items", (b.clone(this.prop("ports/items")) || []).concat(a), c),
                this
            },
            removePort: function(a, c) {
                ...
                return f !== -1 && (e.splice(f, 1),
                d.rewrite = !0,
                this.prop("ports/items", e, d)),
                this
            },
            _createPortData: function() {
                var a = this._validatePorts();
                if (a.length > 0)
                    throw this.set("ports", this.previous("ports")),
                    new Error(a.join(" "));
        ...
        b.extend(a.dia.ElementView.prototype, {
            ...
            _updatePorts: function() {
                ...
                b.each(b.groupBy(c, "group"), function(c, d) {
                    ...
                    b.each(c, this._updatePortAttrs, this),
                    this._layoutPorts(c, e, a.clone())
                }, this)
            },
            _removePorts: function() {
    ...
    joint.routers.manhattan = function(a, b, c) {
        ...
        function g(b, c, d, e) {
            for (var g, h = [], i = f(e.difference(c)), j = c; g = b[j]; ) {
                ...
                k.equals(i) || (h.unshift(j),
                i = k),
                j = g
            }
            var l = f(a.point(j).difference(d));
            return l.equals(i) || h.unshift(j),
            h
        }
        function h(a, c, d) {
            var e = d.step
        ...
        function l(c, d, f, l) {
            ...
            if (c instanceof a.rect ? (m = h(c, l.startDirections, l),
            o = c.center().snapToGrid(q)) : (o = c.clone().snapToGrid(q),
            m = [o]),
            d instanceof a.rect ? (n = h(d, l.endDirections, l),
            p = d.center().snapToGrid(q)) : (p = d.clone().snapToGrid(q),
            n = [p]),
            m = b.filter(m, f.isPointAccessible, f),
            n = b.filter(n, f.isPointAccessible, f),
            m.length > 0 && n.length > 0) {
                ...
                for (var u, v, w = l.directions, x = w.length, y = l.maximumLoops, z = b.invoke(n, "toString"); !r.isEmpty() && y > 0; ) {
                    ...
                    if (z.indexOf(A) >= 0 && (v = j(E, i(B, p, x)),
                    B.equals(p) || v < 180))
                        return l.previousDirAngle = E,
                        g(s, B, o, p);
                    for (var F = 0; F < x; F++)
                        if (u = w[F],
                        v = j(E, u.angle),
                        !(D && v > l.maxAllowedDirectionChange)) {
                            var G = B.clone().offset(u.offsetX, u.offsetY)
                              , H = G.toString();
                            if (!r.isClose(H) && f.isPointAccessible(G)) {
                                var I = C + u.cost + l.penalties[v];
                                (!r.isOpen(H) || I < t[H]) && (s[H] = B,
                                t[H] = I,
                                r.add(H, I + k(G, n)))
                            }
                        }
        ...
        function n(e, f) {
            m(f),
            this.options.perpendicular = !!f.perpendicular;
    ...
    function(a, b, c) {
        ...
        function e(c, e, f) {
            return a.map(c, function(a, b, c) {
                ...
                return (a.dx || a.dy) && e.offset(a.dx || 0, a.dy || 0),
                d(e.round(), 0, a)
            }, b.line(e, f))
        }
        function f(c, e, f, g) {
            ...
            return a.map(c, function(a, b, c) {
                ...
                return (a.dx || a.dy) && l.offset(a.dx || 0, a.dy || 0),
                a.dr && l.move(h, a.dr),
                d(l.round(), m, a)
            })
        }
        function g(c, d) {
            ...
            var f = d.y;
            return a.isString(f) && (f = parseFloat(f) / 100 * c.height),
            b.point(e || 0, f || 0)
        }
        c.layout.Port = {
    ...
    function(a, b, c) {
        ...
        function e(b, c, e, g) {
            ...
            var h, i, j, k, l = c.center().theta(b), m = f(c), n = g.offset, o = 0;
            l < m[1] || l > m[2] ? (j = ".3em",
            h = n,
            i = 0,
            k = "start") : l < m[0] ? (j = "0",
        ...
        function g(b, c, e, g) {
            ...
            var i, j, k, l, m = g.offset, n = 0, o = f(c);
            h < o[1] || h > o[2] ? (k = ".3em",
            i = -m,
            j = 0,
            l = "end") : h < o[0] ? (k = ".6em",
        ...
        function h(c, e, f) {
            ...
            var g, h = b.point(0, 0), i = -c.theta(h), j = i, k = c.clone().move(h, f.offset).difference(c).round(), l = ".3em";
            (i + 90) % 180 === 0 ? (g = e ? "end" : "middle",
            e || i !== -270 || (l = "0em")) : i > -270 && i < -90 ? (g = "start",
            j = i - 180) : g = "end";
            var m = Math.round;
            return d({
                x: m(k.x),
    ...
    joint.highlighters.stroke = {
        ...
        highlight: function(a, b, c) {
            if (!this._views[b.id]) {
                ...
                h.transform(a.el.getCTM().inverse()),
                h.transform(b.getCTM());
                var i = d.padding;
                if (i) {
                    var j = f.x + f.width / 2
                      , k = f.y + f.height / 2
                ...
                n.listenTo(a.model, "remove", n.remove),
                a.vel.append(h)
            }
        },
        unhighlight: function(a, b, c) {
            this._views[b.id] && (this._views[b.id].remove(),
            this._views[b.id] = null )
        }
    };
    joint.shapes.erd = {},
    ...
    joint.layout.DirectedGraph = {
        layout: function(a, b) {
            ...
            var d = c.toGraphLib({
              ...
              , f = b.marginX || 0
              , h = b.marginY || 0;
            b.rankDir && (e.rankdir = b.rankDir),
            b.align && (e.align = b.align),
            b.nodeSep && (e.nodesep = b.nodeSep),
            b.edgeSep && (e.edgesep = b.edgeSep),
            b.rankSep && (e.ranksep = b.rankSep),
            f && (e.marginx = f),
            h && (e.marginy = h),
            d.setGraph(e),
            // hack
            ...
            step = 40,
            d._nodes = {
                "My element":{"width":140,"height":40, x: x, y: y},
                "b":{"width":32,"height":40, x: x+=step, y: y+=step},
                "c":{"width":32,"height":40, x: x+=step, y: y+=step},
                "d":{"width":32,"height":40, x: x+=step, y: y+=step},
                "e":{"width":32,"height":40, x: x+=step, y: y+=step},
                "f":{"width":32,"height":40, x: x+=step, y: y+=step},
                "g":{"width":32,"height":40, x: x+=step, y: y+=step}
            }
            dagre.layout(d, {
        ...
        toGraphLib: function(a, b) {
            ...
            return a.get("cells").each(function(a) {
                if (a.isLink()) {
                    ...
                    d.setNode(a.id, e(a)),
                    d.isCompound() && a.has("parent") && d.setParent(a.id, a.get("parent"))
            }),
            d
        }
    },
